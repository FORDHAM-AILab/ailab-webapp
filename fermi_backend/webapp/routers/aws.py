...
@router.post("/s3/get_file_structure/bucket/key", tags=['s3'])
...
@router.post("/s3/upload_s3_object/bucket/object", tags=['s3'])
...
@router.post("/s3/rename_file/bucket/key/newname", tags=['s3'])
...
@router.post("/s3/create_s3_bucket/bucket/key", tags=['s3'])
...
@router.post("/s3/create_s3_dir/bucket/key", tags=['s3'])
...
@router.post("/s3/create_s3_file/bucket/key", tags=['s3'])
