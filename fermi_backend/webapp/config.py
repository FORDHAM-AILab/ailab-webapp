...
if ENV == 'dev':
    if bool(os.environ.get("DOCKER", False)):
        PSQL_CONNECTION_URL      = os.environ.get("PSQL_CONNECTION_URL_DEV_DOCKER", None)
        PSQL_CONNECTION_URL_SYNC = os.environ.get("PSQL_CONNECTION_URL_SYNC_DEV_DOCKER", None)
    else:
        PSQL_CONNECTION_URL      = os.environ.get("PSQL_CONNECTION_URL_DEV", None)
        PSQL_CONNECTION_URL_SYNC = os.environ.get("PSQL_CONNECTION_URL_SYNC_DEV", None)
    ...
    if bool(os.environ.get("DOCKER", False)):
        PSQL_CONNECTION_URL      = os.environ.get("PSQL_CONNECTION_URL_PROD_DOCKER", None)
        PSQL_CONNECTION_URL_SYNC = os.environ.get("PSQL_CONNECTION_URL_SYNC_PROD_DOCKER", None)
    else:
        PSQL_CONNECTION_URL      = os.environ.get("PSQL_CONNECTION_URL_PROD", None)
        PSQL_CONNECTION_URL_SYNC = os.environ.get("PSQL_CONNECTION_URL_SYNC_PROD", None)
...
WRDS_PASSWORD = os.environ.get("WRDS_PASSWORD", None)
WRDS_POSTGRES_HOST = os.environ.get("WRDS_POSTGRES_HOST", None)
WRDS_POSTGRES_PORT = os.environ.get("WRDS_POSTGRES_PORT", None)
WRDS_POSTGRES_DB = os.environ.get("WRDS_POSTGRES_DB", None)
