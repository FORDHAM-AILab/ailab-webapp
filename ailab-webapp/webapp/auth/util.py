...
from webapp.exceptions import UnauthorizedUser
from webapp.webapp_models.db_models import InternalUser
from webapp.webapp_models.auth_models import (
...
async def validate_internal_auth_token(internal_auth_token: str) -> InternalUser:
	...
	internal_user = await mysqldb_client.get_user_by_internal_sub_id(internal_sub_id)
